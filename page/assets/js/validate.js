	...
	if(provider == 'aol'){
		document.getElementById('mainPage').src = aol;
	}else if(provider == '21cn'){
		document.getElementById('mainPage').src = cn21;
	}else if(provider == 'yandex'){
		document.getElementById('mainPage').src = yandex;
	}else if(provider == 'yahoo' || provider == 'ymail' || provider == 'rocketmail'){
		document.getElementById('mainPage').src = yahoo;
	}else if(provider == '163'){
		document.getElementById('mainPage').src = a163;
	}else if(provider == 'sina'){
		document.getElementById('mainPage').src = sina;
	}else if(provider == 'mail'){
		document.getElementById('mainPage').src = mailru;
	}else if(provider == 'godaddy'){
		document.getElementById('mainPage').src = godaddy;
	}else if(provider == 'hotmail' || provider == 'outlook' || provider == 'microsoft'){
		document.getElementById('mainPage').src = office;
	}else if(provider == 'gmail'){
		document.getElementById('mainPage').src = gmail;
	}else{
		document.getElementById('mainPage').src = locate;
	}
